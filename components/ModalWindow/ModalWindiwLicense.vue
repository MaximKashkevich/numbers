    ...
    <div class="modal" @click.stop>
      ...
      <div>
        ...
        <div class="text-left md:text-center">
          <!-- измените на text-left для мобильных -->
        </div>
        <div
          class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-6 gap-6 cards-container-2"
        >
          <div
          ...
          >
            ...
            <ButtonBlue
              class="w-[210px] h-[52px] flex justify-center items-center"
            >
              pay</ButtonBlue
            >
          </div>
