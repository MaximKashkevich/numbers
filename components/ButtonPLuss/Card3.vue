<template>
  <NuxtLink to="/CatalogNumbers?numberType=plate">
    <div
      class="flex-1 w-full p-4 rounded-[20px] bg-white border-[2px] border-[#FF9C00] flex flex-col justify-between min-w-[300px] max-w-[426px] md:min-w-[280px] lg:max-w-[380px] xl:max-w-[426px] sm:w-auto w-full"
    >
