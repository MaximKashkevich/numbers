    ...
    >
      ...
      <div class="flex-1 min-w-[250px] max-w-[350px] mb-[70px] title">
        ...
        <div class="flex items-center">
          <p class="font-medium my-4 text-2xl mr-2">Cost:</p>
          <h2
            class="font-medium my-4 text-2xl"
            v-html="plateStore.plateDetails.price"
          ></h2>
        </div>
        <p
        ...
        <div class="flex flex-col items-center justify-center h-full">
          <div class="flex items-center justify-center" id="top">
            <img
              ...
              :src="plateStore.plateDetails.photo"
              alt="Dubai Plate"
            />
          </div>
      ...
      <div class="flex-1 max-w-[350px] right-panel">
        ...
        <div class="flex gap-[25px] mt-[30px]">
          <p class="text-[15px] font-normal leading-[19.2px] text-[#B3B3B3]">
            Emirate: {{ plateStore.plateDetails.emirate }}
          </p>
          <p class="text-[15px] font-normal leading-[19.2px] text-[#B3B3B3]">
            Posted {{ plateStore.plateDetails.datePosted }}
          </p>
          <p class="text-[15px] font-normal leading-[19.2px] text-[#B3B3B3]">
            {{ plateStore.plateDetails.views }} Views
          </p>
        </div>
