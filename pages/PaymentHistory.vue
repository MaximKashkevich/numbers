    ...
    >
      ...
      <div class="flex-1">
        ...
        <div>
          ...
          <!-- Table content -->
          <ul
            class="w-full max-w-[872px] h-auto rounded-[10px] border border-[#BFBFBF] bg-[#FAFAFA] mt-[30px]"
          >
            <li class="w-full">
...
export default {
  ...
  setup() {
    ...
    const isCheckboxChecked2 = ref(false);
    const isCheckboxChecked3 = ref(false);
