    ...
    >
      ...
      >
        <div class="">
          ...
          >
            You leave a request to buy a room and specify all the criteria that
        ...
        <div class="flex flex-wrap py-[25px] justify-between items-start">
          <div class="flex-1 min-w-0">
            ...
            <transition name="fade-slide">
              ...
              >
                You can easily update your account information. Just go to your
                Dashboard page and click on the Settings link. From here you can
                do whatever you like with your information.
              </span>
            </transition>
          </div>
