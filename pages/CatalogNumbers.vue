        ...
        <div>
          ...
          <div class="mt-[10px] flex gap-[10px]">
            <div class="flex gap-[10px]">
              <button
                :class="[
                  'button-black w-[130px] h-[47px] rounded-[100px] border font-roboto text-[16px] font-normal leading-[19.2px] text-center',
                  getButtonClass('Plate'),
                ]"
                @click="
                  showPlate();
                  setActive('Plate');
            ...
            <div class="container px-2 flex flex-col gap-8">
              <div class="flex flex-col gap-6 mt-8">
                ...
                <div class="flex flex-wrap gap-4">
                  ...
                  <div>
                    <label
                      class="font-roboto text-lg font-normal leading-[19.2px] text-[#B3B3B3]"
                      >Number of digits:</label
                    >
                    <div
                      class="flex gap-2 button-container pt-1 mb-2 ml-5 flex-wrap"
                    >
                      <MiniButton :disabled="!isActive" @click="shoNumbers(1)"
                        >1</MiniButton
                      >
                      <MiniButton :disabled="!isActive" @click="shoNumbers(2)"
                        >2</MiniButton
                      >
                      <MiniButton :disabled="!isActive" @click="shoNumbers(3)"
                        >3</MiniButton
                      >
                      <MiniButton :disabled="!isActive" @click="shoNumbers(4)"
                        >4</MiniButton
                      >
                      <MiniButton :disabled="!isActive" @click="shoNumbers(5)"
                        >5</MiniButton
                      >
                    </div>
                    <button
                      @click="clearNumberOfDigits"
              ...
              <transition name="fade-slide">
                <div
                  v-if="isExactMatch"
                  class="flex flex-col mt-5 checkbox-container"
                >
                  <label
                    class="font-roboto text-lg font-normal leading-[19.2px] text-[#B3B3B3] mb-2"
                    >Match:</label
